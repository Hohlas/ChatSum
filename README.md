...
Telegram userbot для автоматического анализа сообщений чата с помощью Perplexity AI. Бот собирает сообщения за указанный период, фильтрует шум и создает структурированные выжимки с выделением основных тем и аргументов участников. Результат публикуется в Telegraph и отправляется в ваш канал.

**Для получени выжимки достаточно отправить в чат сообщение**
```
/sum 12h
```

Бот проанализирует последние 12 часов сообщений чате, в котором была отправлена команда, и создаст выжимку с основными темами обсуждения.
